...
Drove growth strategy, user research, and channel expansion, while building an AI ad generation and tracking tool that reduced content cost by 95%.

Improved conversion by 9% under the same acquisition budget and supported internal prioritization and operational efficiency.
...
Designed a rule-driven LLM pipeline for extraction and listing automation, expanded a 1k dataset into 80k usable samples, and achieved 97% accuracy on production test sets.
...
Integrated the AI-driven optimizations into existing course products to improve learning efficiency.
